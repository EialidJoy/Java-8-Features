...
public class PersonJava7ExerciseSolution {
	...
	public static void main(String[] args) {
		...
		printLastNameBeginningWithC(personsList);
	...
	private static void printLastNameBeginningWithC(List<Person> personsList) {
